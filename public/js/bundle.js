    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') {
            (0, _alert.showAlert)('success', 'Successfully logout ');
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error occured on logout');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJpYW5tdWpqdW5pIiwiYSI6ImNsbXZzMWN5OTBxbjYybHZ6eWx6MnJqZTcifQ.WMCkca6iYkEhKm7uPsl0Cw';
